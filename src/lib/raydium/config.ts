...
const MY_RPC_URL = "http://127.0.0.1:8551";

// export const owner: Keypair = Keypair.fromSecretKey(bs58.decode('<YOUR_WALLET_SECRET_KEY>'))
export const owner: Keypair = Keypair.fromSecretKey(wallet.secretKey)
// export const connection = new Connection(MY_RPC_URL) //<YOUR_RPC_URL>
